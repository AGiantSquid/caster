...
class SublimeRule(MergeRule):
    ...
    mapping = {
        ...
        "uppercase":                R(Key("control:down, k, u, control:up"), rdescript="Sublime: Transform Upper"), 
        "lowercase":                R(Key("control:down, k, l, control:up"), rdescript="Sublime: Transform Lower"),
        "outdent":                  R(Key("c-rbrace"), rdescript="Sublime: Outdent"),
        ...
        "prior bookmark":           R(Key("s-f2"), rdescript="Sublime: Prior Bookmark"), 
        "fold":                     R(Key("ac-lbrace"), rdescript="Sublime: Fold"),
        "unfold":                   R(Key("ac-rbrace"), rdescript="Sublime: Unfold"),
        "open file":                R(Key("c-p"), rdescript="Sublime: Open File"), 
        "new file":                 R(Key("c-n"), rdescript="Sublime: New File"),
        "delete line [<n>]":        R(Key("cs-k"), rdescript="Sublime: Delete Line or # Lines Below") * Repeat(extra="n"),
