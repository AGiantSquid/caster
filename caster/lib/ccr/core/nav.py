...
class NavigationNon(MappingRule):
    mapping = {
        ...
        "marco":                            R(Key("c-f"), rdescript="Find"),
        "Martinek [<n>]":                   R(Key("f3"), rdescript="Find Next") * Repeat(extra="n"),
        "my reprieve [<n>]":                R(Key("s-f3"), rdescript="Find Prior") * Repeat(extra="n"),
        ...
        'duke':                             R(Function(navigation.kick, nexus=_NEXUS) * Repeat(2), rdescript="Mouse: Double Click"),
        ...
        "scrodge [<nnavi500>]":             R(Function(navigation.wheel_scroll_down), rdescript="Wheel Scroll"),
        "scroop [<nnavi500>]":              R(Function(navigation.wheel_scroll_up), rdescript="Wheel Scroll"),
        ...
        "dizzle [<n>]":                     R(Key("c-z"), rdescript="Undo") * Repeat(extra="n"),
        "rizzle [<n>]":                     R(Key("c-y"), rdescript="Redo") * Repeat(extra="n"),
        ...
        "totch":                            R(Key("c-w/20"), rdescript="Close Tab"),
        "peach":                            R(Key("c-t"), rdescript="Open New Tab"),
...
class Navigation(MergeRule):
    ...
    mapping = {
        ...
        # keyboard shortcuts
        'sage':                         R(Key("c-s"), rspec="save", rdescript="Save"),
        ...
        "snatch [<nnavi500>]":          R(Key("c-x") + Function(navigation.clipboard_to_file, nexus=_NEXUS), rspec="cut", rdescript="Cut"),
        ...
        "junk [<nnavi50>]":             R(Key("backspace/5:%(nnavi50)d"), rspec="clear", rdescript="Backspace"),
        "(Rick C | Ricksy)":            R(Key("s-end"), rspec="clear", rdescript="Backspace"),
        "(Lecksy | Lexi)":              R(Key("s-home"), rspec="clear", rdescript="Backspace"),
        "snipple":                      R(Key("s-home") + Key("del/5"), rspec="clear", rdescript="Backspace"),
        "(sniper | snipper)":           R(Key("s-end") + Key("del/5"), rspec="clear", rdescript="Backspace"),
        "fish [<nnavi50>]":             R(Key("c-right"), rspec="fish", rdescript="Jump word to the right") * Repeat(extra="nnavi50"),
        ...
        "(Ollie | Holly)":            R(Key("c-a"), rspec="scram", rdescript="Select all words on page") * Repeat(extra="nnavi50"),
        ...
        "cram <textnv>":                R(Function(textformat.format_text_wrapper, cap=3, space=1), rdescript="camelCase"),
        "smash <textnv>":               R(Function(textformat.format_text_wrapper, cap=5, space=1), rdescript="lowercasenospaces"),
        "squash <textnv>":              R(Function(textformat.format_text_wrapper, cap=5, space=0), rdescript="lowercase with spaces"),
        "snake <textnv>":               R(Function(textformat.format_text_wrapper, cap=5, space=3), rdescript="snake_case"),
        "Yeller <textnv>":              R(Function(textformat.format_text_wrapper, cap=1, space=0), rdescript="UPPERCASE"),
        "spine <textnv>":               R(Function(textformat.format_text_wrapper, cap=0, space=2), rdescript="spinal-case-text"),
        "tridal <textnv>":              R(Function(textformat.format_text_wrapper, cap=2, space=0), rdescript="Title Case"),
        "Champ <textnv>":               R(Function(textformat.format_text_wrapper, cap=4, space=0), rdescript="Capitalize first word"),
        "format <textnv>":              R(Function(textformat.prior_text_format), rdescript="Last Text Format"),

        "swick":                       R(Key("a-tab"), rdescript="Alt-Tab"),
